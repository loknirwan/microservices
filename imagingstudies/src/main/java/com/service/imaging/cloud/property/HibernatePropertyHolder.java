...
public class HibernatePropertyHolder {
	...
	@Value("${imagings.hibernate.dialect.name}")
	private String dilectKey;
	
	@Value("${imagings.hibernate.show_sql.name}")
	private String showSqlKey;
	
	@Value("${imagings.hibernate.format_sql.name}")
	private String formatSqlKey;
	
	@Value("${imagings.hibernate.cache.use_second_level_cache.name}")
	private String useSecondLevelCacheKey;
	
	@Value("${imagings.hibernate.cache.query_cache_factory.name}")
	private String queryCacheFactoryKey;
	
	@Value("${imagings.hibernate.cache.region.factory_class.name}")
	private String regionFactoryClassKey;
	
	@Value("${imagings.hibernate.cache.provider_class.name}")
	private String cacheProviderClassKey;
	
	@Value("${imagings.hibernate.dialect}")
	private String dilect;
	
	@Value("${imagings.hibernate.show_sql}")
	private String showSql;
	
	@Value("${imagings.hibernate.format_sql}")
	private String formatSql;
	
	@Value("${imagings.hibernate.cache.use_second_level_cache}")
	private String useSecondLevelCache;
	
	@Value("${imagings.hibernate.cache.query_cache_factory}")
	private String queryCacheFactory;
	
	@Value("${imagings.hibernate.cache.region.factory_class}")
	private String regionFactoryClass;
	
	@Value("${imagings.hibernate.cache.provider_class}")
