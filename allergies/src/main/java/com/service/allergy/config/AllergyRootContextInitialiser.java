...
import com.service.allergy.cloud.property.DataSourcePropertyHolder;
import com.service.allergy.cloud.property.GeneralPropertyHolder;
import com.service.allergy.cloud.property.HibernatePropertyHolder;


@Configuration
@ComponentScan(basePackages= {"com.service.allergy.service", "com.service.allergy.repository"})
public class AllergyRootContextInitialiser {
	...
	public EntityManagerFactory entityManagerFactory(JpaDialect jpaDialect, JpaVendorAdapter jpaVendorAdapter, DataSource dataSource, Properties jpaProperties) {
		...
		factoryBean.setPackagesToScan("com.service.allergy.entity");
