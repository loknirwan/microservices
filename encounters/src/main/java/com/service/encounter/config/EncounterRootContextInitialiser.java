...
import com.service.encounter.cloud.property.DataSourcePropertyHolder;
import com.service.encounter.cloud.property.GeneralPropertyHolder;
import com.service.encounter.cloud.property.HibernatePropertyHolder;


@Configuration
@ComponentScan(basePackages= {"com.service.encounter.service", "com.encounter.patient.repository"})
public class EncounterRootContextInitialiser {
	...
	public EntityManagerFactory entityManagerFactory(JpaDialect jpaDialect, JpaVendorAdapter jpaVendorAdapter, DataSource dataSource, Properties jpaProperties) {
		...
		factoryBean.setPackagesToScan("com.service.encounter.entity");
