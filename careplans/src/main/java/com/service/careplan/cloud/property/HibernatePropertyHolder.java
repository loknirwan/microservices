...
public class HibernatePropertyHolder {
	...
	@Value("${careplans.hibernate.dialect.name}")
	private String dilectKey;
	
	@Value("${careplans.hibernate.show_sql.name}")
	private String showSqlKey;
	
	@Value("${careplans.hibernate.format_sql.name}")
	private String formatSqlKey;
	
	@Value("${careplans.hibernate.cache.use_second_level_cache.name}")
	private String useSecondLevelCacheKey;
	
	@Value("${careplans.hibernate.cache.query_cache_factory.name}")
	private String queryCacheFactoryKey;
	
	@Value("${careplans.hibernate.cache.region.factory_class.name}")
	private String regionFactoryClassKey;
	
	@Value("${careplans.hibernate.cache.provider_class.name}")
	private String cacheProviderClassKey;
	
	@Value("${careplans.hibernate.dialect}")
	private String dilect;
	
	@Value("${careplans.hibernate.show_sql}")
	private String showSql;
	
	@Value("${careplans.hibernate.format_sql}")
	private String formatSql;
	
	@Value("${careplans.hibernate.cache.use_second_level_cache}")
	private String useSecondLevelCache;
	
	@Value("${careplans.hibernate.cache.query_cache_factory}")
	private String queryCacheFactory;
	
	@Value("${careplans.hibernate.cache.region.factory_class}")
	private String regionFactoryClass;
	
	@Value("${careplans.hibernate.cache.provider_class}")
