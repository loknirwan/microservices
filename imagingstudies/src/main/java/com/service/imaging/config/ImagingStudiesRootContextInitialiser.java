...
import com.service.imaging.cloud.property.DataSourcePropertyHolder;
import com.service.imaging.cloud.property.GeneralPropertyHolder;
import com.service.imaging.cloud.property.HibernatePropertyHolder;



@Configuration
@ComponentScan(basePackages= {"com.service.careplan.service", "com.service.careplan.repository"})
public class ImagingStudiesRootContextInitialiser {
	...
	public EntityManagerFactory entityManagerFactory(JpaDialect jpaDialect, JpaVendorAdapter jpaVendorAdapter, DataSource dataSource, Properties jpaProperties) {
		...
		factoryBean.setPackagesToScan("com.service.imaging.entity");
